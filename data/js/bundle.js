    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Signup success');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3001/api/v1/smtp/".concat(id)
          });
        case 3:
          res = _context2.sent;
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('sig_email').value;
    var password = document.getElementById('sig_pass').value;
    var passwordConf = document.getElementById('sig_conf_pass').value;
    console.log(email, password);
    (0, _login.signup)(name, email, password, passwordConf);
  });
}
if (smtpForm) {
