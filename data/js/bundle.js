...
exports.verify = exports.signup = exports.logout = exports.login = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Logging out...');
            window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Continue Verify');
            window.setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alert.show_alert)('error', _context3.t0.response.data.message);
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', 'Verified');
            window.setTimeout(function () {
              location.assign('/activity');
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createSmtp.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.smtp = exports.delSmtp = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var smtp = exports.smtp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(host, port, username, password) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status = 'success') {
            (0, _alert.show_alert)('success', 'Smtp Added');
  ...
  return function smtp(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
var delSmtp = exports.delSmtp = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/smtp/".concat(id)
          });
        case 3:
          res = _context2.sent;
          (0, _alert.show_alert)('success', 'Smtp deleted');
          location.reload(true);
          _context2.next = 11;
          break;
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](0);
          (0, _alert.show_alert)('error', _context2.t0);
        case 11:
        case "end":
          return _context2.stop();
      }
  ...
  return function delSmtp(_x5) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"mail.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.smtpMail = exports.dnsMail = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var dnsMail = exports.dnsMail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(license, senderName, senderEmail, subject, reciever, message, attachment) {
    var formData, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function dnsMail(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
var smtpMail = exports.smtpMail = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(contact, fromMail, smtp, message, subject, attachment) {
    var formData, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 15:
          _context2.prev = 15;
          _context2.t0 = _context2["catch"](0);
          (0, _alert.show_alert)('error', _context2.t0.response.data.message);
        case 18:
        case "end":
          return _context2.stop();
      }
  ...
  return function smtpMail(_x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref2.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.show_alert)('success', "".concat(type.toUpperCase(), " Updated"));
            window.setTimeout(function () {
              location.assign('#');
            }, 1500);
          }
...
var _createSmtp = require("./createSmtp");
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var loginForm = document.querySelector('form.sign-in-form');
var verifyForm = document.querySelector('form.sign-otp-form');
var logoutBtn = document.getElementById('logoutbtn');
var signupForm = document.querySelector('form.sign-up-form');
var smtpForm = document.querySelector('form.smtp-form');
var delSmtpBtn = document.querySelectorAll('.btn-danger');
var sendSpoof = document.querySelector('.form-spoof');
var sendSmtp = document.querySelector('.form-smtp');
var nextBtn = document.getElementById('next-btn');
var prevBtn = document.getElementById('prev-btn');
var profilePage = document.getElementById('profile-change-form');
var passChangeForm = document.getElementById('password-change-form');
if (loginForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            password = document.getElementById('log_pass').value; // console.log(email, password);
            _context.next = 6;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            code = document.getElementById('code_verify').value;
            _context2.next = 5;
            return (0, _login.verify)(code);
          case 5:
...
if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var name, email, password, passwordConf;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            document.getElementById('sign-up-btn').value = 'Signing Up..';
            name = document.getElementById('sig_name').value;
            email = document.getElementById('sig_email').value;
            password = document.getElementById('sig_pass').value;
            passwordConf = document.getElementById('sig_conf_pass').value; // console.log(email, password);
            _context3.next = 8;
            return (0, _login.signup)(name, email, password, passwordConf);
          case 8:
...
if (smtpForm) {
  smtpForm.addEventListener('submit', function (e) {
    ...
    var username = document.getElementById('smtp-username').value;
    var password = document.getElementById('smtp-password').value;
    (0, _createSmtp.smtp)(host, port, username, password);
...
if (delSmtpBtn) {
  delSmtpBtn.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      var smtpId = button.getAttribute('data-id');
      (0, _createSmtp.delSmtp)(smtpId);
    });
  });
}
if (sendSpoof) {
  console.log('hello worl');
  sendSpoof.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var sendButton, fromName, fromEmail, recEmail, subject, message, attachment;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            sendButton = document.getElementById('send_mail_btn'); // console.log(typeof document.getElementById('send_mail_btn').innerHTML);
            sendButton.innerText = 'Sending ...';
            fromName = document.getElementById('from-name').value;
            fromEmail = document.getElementById('from-email').value;
            recEmail = document.getElementById('to-email').value;
            subject = document.getElementById('email-subject').value;
            message = document.getElementById('email-message').value;
            attachment = document.getElementById('attachment').files[0];
            console.log(attachment);
            _context4.next = 12;
            return (0, _mail.dnsMail)('test__key', fromName, fromEmail, subject, recEmail, message, attachment);
          case 12:
...
if (sendSmtp) {
  sendSmtp.addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
      var smtpDetails, smtp, _smtpDetails$split, _smtpDetails$split2, fromName, fromEmail, recEmail, subject, message, attachment, fromMail, contact;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            e.preventDefault();
            document.getElementById('send_mail_btn').innerText = 'Email sendout processing... ';
            smtpDetails = document.getElementById('smtp-server').value;
            smtp = {};
            _smtpDetails$split = smtpDetails.split('|');
            _smtpDetails$split2 = _slicedToArray(_smtpDetails$split, 4);
            smtp.host = _smtpDetails$split2[0];
            smtp.port = _smtpDetails$split2[1];
            smtp.username = _smtpDetails$split2[2];
            smtp.password = _smtpDetails$split2[3];
            fromName = document.getElementById('from-name').value;
            fromEmail = document.getElementById('from-email').value;
            recEmail = document.getElementById('to-email').value;
            subject = document.getElementById('email-subject').value;
            ...
            _context5.next = 20;
            return (0, _mail.smtpMail)(contact, fromMail, smtp, message, subject, attachment);
          case 20:
            document.getElementById('send_mail_btn').innerText = 'Send Email';
          case 21:
          case "end":
...
if (profilePage) {
  profilePage.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    console.log(form);
    (0, _updateProfile.updateData)(form, 'data');
  });
}
if (passChangeForm) {
  passChangeForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 6;
            return (0, _updateProfile.updateData)({
...
},{"./login":"login.js","./createSmtp":"createSmtp.js","./mail":"mail.js","./updateProfile":"updateProfile.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
